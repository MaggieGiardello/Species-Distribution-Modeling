...
#get our occurrence data, simplified to just lat/long
occurrenceCoords<-read_csv("data/cleanData.csv") %>%
  dplyr::select( decimalLongitude, decimalLatitude)

#covert to spatial points for the model 
...
#lets creata a raster stack (stack of layers/variables)
#list of files
...
#create the raster stac from the files list 
...
#standarize random points for reproducability 
set.seed(45) 

#creates pseudo-abscence points 
...
#create a gird of measurement for the pseudo absence points
...
#create a spatial pixel data frame 
